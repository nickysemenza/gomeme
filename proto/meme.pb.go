...
var file_proto_meme_proto_rawDesc = string([]byte{
...
var (
	...
	file_proto_meme_proto_rawDescData []byte
)

func file_proto_meme_proto_rawDescGZIP() []byte {
	file_proto_meme_proto_rawDescOnce.Do(func() {
		file_proto_meme_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_proto_meme_proto_rawDesc), len(file_proto_meme_proto_rawDesc)))
	})
...
var file_proto_meme_proto_goTypes = []any{
...
func file_proto_meme_proto_init() {
	...
	file_proto_meme_proto_msgTypes[1].OneofWrappers = []any{}
	file_proto_meme_proto_msgTypes[4].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_proto_meme_proto_rawDesc), len(file_proto_meme_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   15,
			NumExtensions: 0,
			NumServices:   1,
