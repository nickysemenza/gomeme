...
func TestGenerate(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			TargetInputs: []*proto.TargetInput{
				{Input: &proto.TargetInput_ImageInput{ImageInput: &proto.ImageInput{URL: "data:image/png;base64,", Stretch: true}}},
